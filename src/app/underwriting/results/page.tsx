...
export default async function UnderwritingResultsPage() {
    ...
    <div className="min-h-screen bg-[#0f1115] text-white">
      <header className="border-b border-white/10 bg-[#111418] px-6 py-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold">Underwriting Results</h1>
            <p className="text-sm text-white/60 mt-1">Review outputs and next steps</p>
          </div>
          <Link
            href="/deals"
