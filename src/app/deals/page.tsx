...
<span class="text-[12px] font-medium tracking-wide">Command</span>
</button>
...
<span class="text-[12px] font-medium tracking-wide text-primary">Deals</span>
</button>
<button class="group flex flex-col items-center gap-1.5 w-full relative opacity-60 hover:opacity-100 transition-all">
<span class="material-symbols-outlined text-[28px]">description</span>
<span class="text-[12px] font-medium tracking-wide">Evidence</span>
</button>
<button class="group flex flex-col items-center gap-1.5 w-full relative opacity-60 hover:opacity-100 transition-all">
<span class="material-symbols-outlined text-[28px]">fact_check</span>
<span class="text-[12px] font-medium tracking-wide">Underwriting</span>
</button>
<button class="group flex flex-col items-center gap-1.5 w-full relative opacity-60 hover:opacity-100 transition-all">
<span class="material-symbols-outlined text-[28px]">public</span>
<span class="text-[12px] font-medium tracking-wide">Portal</span>
</button>
<button class="group flex flex-col items-center gap-1.5 w-full relative opacity-60 hover:opacity-100 transition-all">
<span class="material-symbols-outlined text-[28px]">settings_suggest</span>
<span class="text-[12px] font-medium tracking-wide">Ops</span>
</button>
</nav>
...
<span class="uppercase tracking-wider text-[12px] opacity-60 mr-2">System Status</span>
...
<span class="text-[12px] font-bold text-emerald-400 flex items-center bg-emerald-500/10 px-1.5 py-0.5 rounded">
...
<span class="text-[12px] font-bold text-amber-400 flex items-center bg-amber-500/10 px-1.5 py-0.5 rounded">
                                +2
                            </span>
</div>
...
<span class="text-[12px] font-bold text-gray-400 flex items-center">
                                -3
                            </span>
</div>
...
<span class="text-[12px] font-bold text-rose-400 flex items-center bg-rose-500/10 px-1.5 py-0.5 rounded">
                                Critical
                            </span>
</div>
...
<span class="text-[12px] font-bold text-emerald-400 flex items-center">
                                0%
                            </span>
</div>
...
<span class="text-[12px] text-gray-500">2m ago • Auto-detected</span>
</div>
</div>
...
<span class="text-[12px] text-gray-500">15m ago • Experian</span>
</div>
</div>
</div>
...
<span class="bg-rose-500/20 text-rose-400 text-[12px] font-bold px-1.5 py-0.5 rounded">2 Critical</span>
</div>
<div class="space-y-2">
...
<span class="text-[12px] text-gray-500 bg-black/20 px-1.5 rounded">Required</span>
</div>
<div class="flex items-center justify-between p-2 rounded-lg bg-white/5 border border-white/5">
<div class="flex items-center gap-2">
...
<span class="text-[12px] text-gray-500 bg-black/20 px-1.5 rounded">Expiring</span>
</div>
</div>
