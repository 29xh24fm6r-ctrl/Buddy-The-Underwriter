 ...
 *
 * Counterpart to /api/portal/share/view — accepts one file per request from
 * the token-gated /portal/share/[token] page (a third party the banker sent
 * a scoped checklist-item share link to, e.g. an accountant). Auth is the
