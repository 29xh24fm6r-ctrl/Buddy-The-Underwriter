...
export default function TemplatesVaultPage() {
  const items = [
    {
      title: "Document Requirements",
      description: "Configure borrower upload requirements and packs.",
    ...
    },
    {
      ...
      description: "Review uploaded documents and evidence records.",
      href: "/documents",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-[#0f1115] text-white">
      <header className="border-b border-white/10 bg-[#111418] px-6 py-4">
        <div>
          <h1 className="text-2xl font-bold">Template Vault</h1>
          <p className="text-sm text-white/60 mt-1">
            Manage templates, policies, and document requirements
          </p>
        </div>
      </header>
