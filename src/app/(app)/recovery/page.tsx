...
export default async function Page() {
    ...
    return (
        <div className="min-h-screen bg-[#111418] text-white">
            <header className="border-b border-white/10 bg-[#161b22] px-6 py-4">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl font-bold">Charge-Off & Recovery</h1>
                        <p className="text-sm text-white/60 mt-1">Loss mitigation and recovery tracking</p>
                    </div>
                    <Link
                        href="/deals"
            ...
            <main className="p-6">
                <div className="bg-[#1a2028] border border-white/10 rounded-lg overflow-hidden">
