...
export const BORROWER_FIELD_REGISTRY: BorrowerFieldEntry[] = [
  ...
  { key: "contact_name", label: "Business contact name", type: "string", entityScope: "business", factPath: "business.contact_name", sourceTable: "borrowers", sourceColumn: "contact_name", appliesToForms: ["1244"], requiredForForms: ["1244"], sensitive: false },
  { key: "contact_email", label: "Business contact email", type: "string", entityScope: "business", factPath: "business.contact_email", sourceTable: "borrowers", sourceColumn: "contact_email", appliesToForms: ["1244"], requiredForForms: ["1244"], sensitive: false },
