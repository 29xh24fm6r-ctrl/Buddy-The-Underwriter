...
export const BORROWER_FIELD_REGISTRY: BorrowerFieldEntry[] = [
  ...
  // Real Form 1244 asks "Type of Business (Summary Description)", sourced
  // from naics_description, not the naics_code entry below — "1244"
  // removed here (confirmed against a real copy of the PDF), see
  // type_of_business entry further down instead.
  { key: "naics_code", label: "NAICS code", type: "string", entityScope: "business", factPath: "business.naics", sourceTable: "borrowers", sourceColumn: "naics_code", appliesToForms: ["1919"], requiredForForms: ["1919"], sensitive: false },
  ...
  // Not a real 1244 question (confirmed against a real copy of the PDF)
  // — "1244" removed.
  { key: "year_founded", label: "Year business founded", type: "number", entityScope: "business", factPath: "business.year_founded", sourceTable: "borrowers", sourceColumn: "year_founded", appliesToForms: ["1919"], requiredForForms: ["1919"], sensitive: false },
  // Real Form 1244's "prior application submitted to SBA" question is
  // sourced from prior_project_application_submitted instead (see the
  // prior_application_submitted entry further down) — "1244" removed
  // here, this column isn't read by form1244/inputBuilder.ts.
  { key: "has_pending_sba_application", label: "Other SBA application pending?", type: "boolean", entityScope: "business", factPath: "business.has_pending_sba_application", sourceTable: "borrowers", sourceColumn: "has_pending_sba_application", appliesToForms: [], requiredForForms: [], sensitive: false },
  ...
  // Not a real 1244 question (confirmed against a real copy of the PDF)
  // — "1244" removed; column kept as-is, not this task's call to delete.
  { key: "is_engaged_in_lobbying", label: "Engaged in lobbying activities?", type: "boolean", entityScope: "business", factPath: "business.is_engaged_in_lobbying", sourceTable: "borrowers", sourceColumn: "is_engaged_in_lobbying", appliesToForms: [], requiredForForms: [], sensitive: false },
  // ── business — Form 1244 Section One fields with no prior representation ──
  { key: "duns_number", label: "Business DUNS number", type: "string", entityScope: "business", factPath: "business.duns_number", sourceTable: "borrowers", sourceColumn: "duns_number", appliesToForms: ["1244"], requiredForForms: [], sensitive: false },
  { key: "website", label: "Business web address", type: "string", entityScope: "business", factPath: "business.website", sourceTable: "borrowers", sourceColumn: "website", appliesToForms: ["1244"], requiredForForms: [], sensitive: false },
  { key: "contact_name", label: "Business contact name", type: "string", entityScope: "business", factPath: "business.contact_name", sourceTable: "borrowers", sourceColumn: "contact_name", appliesToForms: ["1919", "1244"], requiredForForms: ["1919", "1244"], sensitive: false },
  { key: "contact_email", label: "Business contact email", type: "string", entityScope: "business", factPath: "business.contact_email", sourceTable: "borrowers", sourceColumn: "contact_email", appliesToForms: ["1919", "1244"], requiredForForms: ["1919", "1244"], sensitive: false },
  { key: "type_of_business", label: "Type of business (summary description)", type: "string", entityScope: "business", factPath: "business.type_of_business", sourceTable: "borrowers", sourceColumn: "naics_description", appliesToForms: ["1244"], requiredForForms: ["1244"], sensitive: false },
  { key: "has_affiliates", label: "Does the Applicant have any affiliates?", type: "boolean", entityScope: "business", factPath: "business.has_affiliates", sourceTable: "borrowers", sourceColumn: "has_affiliates", appliesToForms: ["1244"], requiredForForms: ["1244"], sensitive: false },
  { key: "obtained_direct_or_guaranteed_loan", label: "Ever obtained/applied for a direct or guaranteed government loan?", type: "boolean", entityScope: "business", factPath: "business.obtained_direct_or_guaranteed_loan", sourceTable: "borrowers", sourceColumn: "obtained_direct_or_guaranteed_government_loan", appliesToForms: ["1244"], requiredForForms: ["1244"], sensitive: false },
  { key: "prior_application_submitted", label: "Application for this project previously submitted to SBA?", type: "boolean", entityScope: "business", factPath: "business.prior_application_submitted", sourceTable: "borrowers", sourceColumn: "prior_project_application_submitted", appliesToForms: ["1244"], requiredForForms: ["1244"], sensitive: false },
  { key: "prior_cdc_lender_name_and_program", label: "Prior CDC/Lender name and loan program, if previously submitted", type: "string", entityScope: "business", factPath: "business.prior_cdc_lender_name_and_program", sourceTable: "borrowers", sourceColumn: "prior_project_cdc_lender_name_and_program", appliesToForms: ["1244"], requiredForForms: [], sensitive: false },
  ...
  { key: "ownership_pct", label: "Ownership percentage", type: "number", entityScope: "owner", factPath: "owner.ownership_pct", sourceTable: "ownership_entities", sourceColumn: "ownership_pct", appliesToForms: ["148", "912", "1244"], requiredForForms: ["148", "912"], sensitive: false },
  // Form 148L — 7 mutually-exclusive limitation types, each with its own
  // amount/rate/description field, only asked for a "limited" guarantor
  // (see src/lib/ownership/rules.ts's determineGuaranteeType).
  { key: "guarantee_limitation_type", label: "Guarantee limitation type", type: "string", entityScope: "owner", factPath: "owner.guarantee_limitation_type", sourceTable: "ownership_entities", sourceColumn: "guarantee_limitation_type", appliesToForms: ["148"], requiredForForms: ["148"], sensitive: false },
  { key: "guarantee_limit_balance_under", label: "Released when total amount owing drops below", type: "number", entityScope: "owner", factPath: "owner.guarantee_limit_balance_under", sourceTable: "ownership_entities", sourceColumn: "guarantee_limit_balance_under", appliesToForms: ["148"], requiredForForms: [], sensitive: false },
  { key: "guarantee_limit_principal_under", label: "Released when principal balance drops below", type: "number", entityScope: "owner", factPath: "owner.guarantee_limit_principal_under", sourceTable: "ownership_entities", sourceColumn: "guarantee_limit_principal_under", appliesToForms: ["148"], requiredForForms: [], sensitive: false },
  { key: "guarantee_limit_max_payment", label: "Maximum guarantor payment", type: "number", entityScope: "owner", factPath: "owner.guarantee_limit_max_payment", sourceTable: "ownership_entities", sourceColumn: "guarantee_limit_max_payment", appliesToForms: ["148"], requiredForForms: [], sensitive: false },
  ...
  { key: "full_ssn", label: "Social Security Number (full)", type: "string", entityScope: "owner", factPath: "owner.full_ssn", sourceTable: "deal_pii_records", sourceColumn: "encrypted_payload", appliesToForms: ["1919", "912", "4506c", "413", "1244"], requiredForForms: ["912", "4506c", "413", "1244"], sensitive: true },
  ...
  // Not read by form1244/inputBuilder.ts (confirmed against a real copy
  // of the PDF) — "1244" removed from both.
  { key: "principal_residence_in_us", label: "Principal residence is in the U.S.", type: "boolean", entityScope: "owner", factPath: "owner.principal_residence_in_us", sourceTable: "ownership_entities", sourceColumn: "principal_residence_in_us", appliesToForms: ["1919", "912"], requiredForForms: ["1919", "912"], sensitive: true },
  { key: "alien_registration_number", label: "Alien registration number", type: "string", entityScope: "owner", factPath: "owner.alien_registration_number", sourceTable: "ownership_entities", sourceColumn: "alien_registration_number", appliesToForms: ["1919"], requiredForForms: [], sensitive: true },
  // "148" removed from these 4 — the real 148/148L don't ask for the
  // guarantor's address at all (confirmed against real copies of both
  // PDFs; docs/sba-forms/148-fields.json, 148l-fields.json).
  { key: "home_address_street", label: "Home address — street", type: "string", entityScope: "owner", factPath: "owner.home_address_street", sourceTable: "ownership_entities", sourceColumn: "home_address_street", appliesToForms: ["1919", "1244", "912", "4506c", "413"], requiredForForms: ["1919", "1244", "912", "4506c", "413"], sensitive: false },
  { key: "home_address_city", label: "Home address — city", type: "string", entityScope: "owner", factPath: "owner.home_address_city", sourceTable: "ownership_entities", sourceColumn: "home_address_city", appliesToForms: ["1919", "1244", "912", "4506c", "413"], requiredForForms: ["1919", "1244", "912", "4506c", "413"], sensitive: false },
  { key: "home_address_state", label: "Home address — state", type: "string", entityScope: "owner", factPath: "owner.home_address_state", sourceTable: "ownership_entities", sourceColumn: "home_address_state", appliesToForms: ["1919", "1244", "912", "4506c", "413"], requiredForForms: ["1919", "1244", "912", "4506c", "413"], sensitive: false },
  { key: "home_address_zip", label: "Home address — ZIP", type: "string", entityScope: "owner", factPath: "owner.home_address_zip", sourceTable: "ownership_entities", sourceColumn: "home_address_zip", appliesToForms: ["1919", "1244", "912", "4506c", "413"], requiredForForms: ["1919", "1244", "912", "4506c", "413"], sensitive: false },
  { key: "home_phone", label: "Home phone", type: "string", entityScope: "owner", factPath: "owner.home_phone", sourceTable: "ownership_entities", sourceColumn: "home_phone", appliesToForms: ["413", "1244"], requiredForForms: ["413", "1244"], sensitive: false },
  ...
  // Not read by form1244/inputBuilder.ts (confirmed against a real copy
  // of the PDF) — "1244" removed from both.
  { key: "is_us_government_employee", label: "Employee of U.S. government?", type: "boolean", entityScope: "owner", factPath: "owner.is_us_government_employee", sourceTable: "ownership_entities", sourceColumn: "is_us_government_employee", appliesToForms: ["1919"], requiredForForms: ["1919"], sensitive: false },
  { key: "has_other_government_employment", label: "Other government employment?", type: "boolean", entityScope: "owner", factPath: "owner.has_other_government_employment", sourceTable: "ownership_entities", sourceColumn: "has_other_government_employment", appliesToForms: ["1919"], requiredForForms: ["1919"], sensitive: false },
  ...
  // respectively — see the new entries below). arrested_or_charged_6mo
  // and subject_to_indictment ARE confirmed real Form 1244 columns
  // (form1244/inputBuilder.ts reads them directly); convicted_or_pleaded/
  // pending_criminal_charges/on_parole_or_probation are NOT — 1244's real
  // combined question reads convicted_diversion_or_parole instead (new
  // entry below), and there's no separate "pending criminal charges"
  // concept on the real form. Kept because src/lib/score/* still depends
  // on these exact columns for underwriting character-flag scoring.
  ...
  { key: "convicted_or_pleaded", label: "Convicted or pleaded guilty/nolo?", type: "boolean", entityScope: "owner", factPath: "owner.convicted_or_pleaded", sourceTable: "ownership_entities", sourceColumn: "convicted_or_pleaded", appliesToForms: [], requiredForForms: [], sensitive: true },
  { key: "pending_criminal_charges", label: "Pending criminal charges?", type: "boolean", entityScope: "owner", factPath: "owner.pending_criminal_charges", sourceTable: "ownership_entities", sourceColumn: "pending_criminal_charges", appliesToForms: [], requiredForForms: [], sensitive: true },
  ...
  { key: "on_parole_or_probation", label: "On parole or probation?", type: "boolean", entityScope: "owner", factPath: "owner.on_parole_or_probation", sourceTable: "ownership_entities", sourceColumn: "on_parole_or_probation", appliesToForms: [], requiredForForms: [], sensitive: true },
  // ── owner — Form 1244 Section Two fields with no prior representation ──
  { key: "former_names_and_dates_used", label: "Former names and dates used", type: "string", entityScope: "owner", factPath: "owner.former_names_and_dates_used", sourceTable: "ownership_entities", sourceColumn: "former_names_and_dates_used", appliesToForms: ["1244"], requiredForForms: [], sensitive: true },
  { key: "country_of_citizenship", label: "Country of citizenship, if not a U.S. citizen", type: "string", entityScope: "owner", factPath: "owner.country_of_citizenship", sourceTable: "ownership_entities", sourceColumn: "country_of_citizenship", appliesToForms: ["1244"], requiredForForms: [], sensitive: true },
  { key: "sba_loan_entity_interest", label: "Ownership interest in another entity with existing SBA loans?", type: "boolean", entityScope: "owner", factPath: "owner.sba_loan_entity_interest", sourceTable: "ownership_entities", sourceColumn: "sba_loan_entity_interest", appliesToForms: ["1244"], requiredForForms: ["1244"], sensitive: false },
  { key: "sba_loan_entity_interest_details", label: "SBA loan numbers and current status, if applicable", type: "string", entityScope: "owner", factPath: "owner.sba_loan_entity_interest_details", sourceTable: "ownership_entities", sourceColumn: "sba_loan_entity_interest_details", appliesToForms: ["1244"], requiredForForms: [], sensitive: false },
  { key: "convicted_diversion_or_parole", label: "Ever convicted/pleaded guilty/nolo/pretrial diversion/parole for a criminal offense (other than minor vehicle violation)?", type: "boolean", entityScope: "owner", factPath: "owner.convicted_diversion_or_parole", sourceTable: "ownership_entities", sourceColumn: "convicted_diversion_or_parole", appliesToForms: ["1244"], requiredForForms: ["1244"], sensitive: true },
  { key: "suspended_debarred_ineligible", label: "Presently suspended/debarred/ineligible/excluded from federal participation?", type: "boolean", entityScope: "owner", factPath: "owner.suspended_debarred_ineligible", sourceTable: "ownership_entities", sourceColumn: "suspended_debarred_ineligible", appliesToForms: ["1244"], requiredForForms: ["1244"], sensitive: true },
  ...
  // form1244/inputBuilder.ts's owner roster doesn't distinguish an
  // "entity" scope from "owner" — it reads plain owner-scope columns
  // (display_name/title/ownership_pct) regardless of entity_type, and has
  // no separate entity legal-name/EIN/address concept — "1244" removed
  // from all 6 below (confirmed against a real copy of the PDF).
  { key: "entity_legal_name", label: "Entity legal name", type: "string", entityScope: "entity", factPath: "entity.legal_name", sourceTable: "ownership_entities", sourceColumn: "display_name", appliesToForms: ["1919"], requiredForForms: ["1919"], sensitive: false },
  { key: "entity_ein", label: "Entity EIN", type: "string", entityScope: "entity", factPath: "entity.ein", sourceTable: "ownership_entities", sourceColumn: "entity_ein", appliesToForms: ["1919"], requiredForForms: ["1919"], sensitive: true },
  { key: "entity_type_of_entity", label: "Entity type", type: "string", entityScope: "entity", factPath: "entity.entity_type", sourceTable: "ownership_entities", sourceColumn: "entity_type", appliesToForms: ["1919"], requiredForForms: ["1919"], sensitive: false },
  { key: "entity_address_street", label: "Entity address — street", type: "string", entityScope: "entity", factPath: "entity.address_street", sourceTable: "ownership_entities", sourceColumn: "entity_address_street", appliesToForms: ["1919"], requiredForForms: ["1919"], sensitive: false },
  { key: "entity_address_city", label: "Entity address — city", type: "string", entityScope: "entity", factPath: "entity.address_city", sourceTable: "ownership_entities", sourceColumn: "entity_address_city", appliesToForms: ["1919"], requiredForForms: ["1919"], sensitive: false },
  { key: "entity_address_state", label: "Entity address — state", type: "string", entityScope: "entity", factPath: "entity.address_state", sourceTable: "ownership_entities", sourceColumn: "entity_address_state", appliesToForms: ["1919"], requiredForForms: ["1919"], sensitive: false },
  { key: "entity_address_zip", label: "Entity address — ZIP", type: "string", entityScope: "entity", factPath: "entity.address_zip", sourceTable: "ownership_entities", sourceColumn: "entity_address_zip", appliesToForms: ["1919"], requiredForForms: ["1919"], sensitive: false },

  // ── loan (deal_loan_requests / deals, deal-level singleton facts) ──────
  { key: "amount_requested", label: "Loan amount requested", type: "number", entityScope: "loan", factPath: "loan.amount_requested", sourceTable: "deal_loan_requests", sourceColumn: "requested_amount", appliesToForms: ["1919", "148", "155", "1244"], requiredForForms: ["1919", "148", "155", "1244"], sensitive: false },
  ...
  { key: "loan_purpose", label: "Purpose of the loan", type: "string", entityScope: "loan", factPath: "loan.loan_purpose", sourceTable: "deal_loan_requests", sourceColumn: "loan_purpose", appliesToForms: ["1244"], requiredForForms: ["1244"], sensitive: false },
  { key: "jobs_to_be_created", label: "# of jobs to be created in the next two years", type: "number", entityScope: "loan", factPath: "loan.jobs_to_be_created", sourceTable: "deal_loan_requests", sourceColumn: "jobs_created_count", appliesToForms: ["1244"], requiredForForms: [], sensitive: false },
  { key: "jobs_to_be_retained", label: "# of jobs to be retained in the next two years", type: "number", entityScope: "loan", factPath: "loan.jobs_to_be_retained", sourceTable: "deal_loan_requests", sourceColumn: "jobs_retained_count", appliesToForms: ["1244"], requiredForForms: [], sensitive: false },
  // Gates whether the Operating Company sub-fields below apply at all —
  // not itself a printed Yes/No question on the form, but a deal-setup
  // fact Buddy needs before it can know whether to ask for them.
  { key: "is_eligible_passive_company", label: "Is this an Eligible Passive Company (EPC) / Operating Company structure?", type: "boolean", entityScope: "loan", factPath: "loan.is_eligible_passive_company", sourceTable: "deals", sourceColumn: "is_eligible_passive_company", appliesToForms: ["1244"], requiredForForms: ["1244"], sensitive: false },
  // Real Form 1244's Operating Company block — only required when
  // is_eligible_passive_company is true (a static requiredForForms list
  // can't express that condition, same pattern as the 148L
  // guarantee_limit_* fields above) — see form1244/build.ts's
  // OC_REQUIRED_WHEN_EPC_KEYS for the 7 that become required.
  { key: "oc_legal_name", label: "Operating Company legal name", type: "string", entityScope: "loan", factPath: "loan.oc_legal_name", sourceTable: "deals", sourceColumn: "operating_company_legal_name", appliesToForms: ["1244"], requiredForForms: [], sensitive: false },
  { key: "oc_address", label: "Operating Company business address", type: "string", entityScope: "loan", factPath: "loan.oc_address", sourceTable: "deals", sourceColumn: "operating_company_address", appliesToForms: ["1244"], requiredForForms: [], sensitive: false },
  { key: "oc_dba", label: "Operating Company DBA", type: "string", entityScope: "loan", factPath: "loan.oc_dba", sourceTable: "deals", sourceColumn: "operating_company_dba", appliesToForms: ["1244"], requiredForForms: [], sensitive: false },
  { key: "oc_legal_structure", label: "Operating Company legal structure", type: "string", entityScope: "loan", factPath: "loan.oc_legal_structure", sourceTable: "deals", sourceColumn: "operating_company_legal_structure", appliesToForms: ["1244"], requiredForForms: [], sensitive: false },
  { key: "oc_tax_id", label: "Operating Company Tax ID", type: "string", entityScope: "loan", factPath: "loan.oc_tax_id", sourceTable: "deals", sourceColumn: "operating_company_tax_id", appliesToForms: ["1244"], requiredForForms: [], sensitive: true },
  { key: "oc_duns_number", label: "Operating Company DUNS number", type: "string", entityScope: "loan", factPath: "loan.oc_duns_number", sourceTable: "deals", sourceColumn: "operating_company_duns_number", appliesToForms: ["1244"], requiredForForms: [], sensitive: false },
  { key: "oc_contact_name", label: "Operating Company contact name", type: "string", entityScope: "loan", factPath: "loan.oc_contact_name", sourceTable: "deals", sourceColumn: "operating_company_contact_name", appliesToForms: ["1244"], requiredForForms: [], sensitive: false },
  { key: "oc_email", label: "Operating Company email address", type: "string", entityScope: "loan", factPath: "loan.oc_email", sourceTable: "deals", sourceColumn: "operating_company_email", appliesToForms: ["1244"], requiredForForms: [], sensitive: false },
  { key: "oc_phone", label: "Operating Company phone", type: "string", entityScope: "loan", factPath: "loan.oc_phone", sourceTable: "deals", sourceColumn: "operating_company_phone", appliesToForms: ["1244"], requiredForForms: [], sensitive: false },
  { key: "oc_website", label: "Operating Company web address", type: "string", entityScope: "loan", factPath: "loan.oc_website", sourceTable: "deals", sourceColumn: "operating_company_website", appliesToForms: ["1244"], requiredForForms: [], sensitive: false },
  ...
  { key: "sba_loan_number", label: "SBA-assigned loan number", type: "string", entityScope: "loan", factPath: "loan.sba_loan_number", sourceTable: "sba_loans", sourceColumn: "loan_number", appliesToForms: ["155", "148"], requiredForForms: ["155"], sensitive: false },
  { key: "sba_loan_closing_date", label: "SBA loan closing date", type: "date", entityScope: "loan", factPath: "loan.sba_loan_closing_date", sourceTable: "sba_loans", sourceColumn: "closing_date", appliesToForms: ["148"], requiredForForms: [], sensitive: false },
  ...
  { key: "contractor_address", label: "Contractor address", type: "string", entityScope: "loan", factPath: "loan.contractor_address", sourceTable: "deal_loan_requests", sourceColumn: "contractor_address", appliesToForms: ["601"], requiredForForms: [], sensitive: false },
  { key: "contractor_phone", label: "Contractor phone", type: "string", entityScope: "loan", factPath: "loan.contractor_phone", sourceTable: "deal_loan_requests", sourceColumn: "contractor_phone", appliesToForms: ["601"], requiredForForms: [], sensitive: false },
  { key: "contractor_authorized_official", label: "Contractor's authorized official — name & title", type: "string", entityScope: "loan", factPath: "loan.contractor_authorized_official", sourceTable: "deal_loan_requests", sourceColumn: "contractor_authorized_official", appliesToForms: ["601"], requiredForForms: [], sensitive: false },
  // The real 601 has no distinct "compliance certification acknowledged"
  // checkbox — signing the document itself is the certification (same
  // pattern as Form 155's dropped subordination_terms_acknowledged).
  { key: "compliance_certification_acknowledged", label: "Compliance certification acknowledged (superseded — signing is the certification)", type: "boolean", entityScope: "loan", factPath: "loan.compliance_certification_acknowledged", sourceTable: "deal_loan_requests", sourceColumn: "compliance_certification_acknowledged", appliesToForms: [], requiredForForms: [], sensitive: false },
  // Real 148L has 7 mutually-exclusive limitation types, each
  // bank-negotiated per guarantor — not one deal-wide cap amount, which
  // is why this is now owner-scoped (see the guarantee_limit_* entries
  // in the owner section above) rather than a loan-level fact. Column
  // kept for now (unused), not this task's call to delete.
  { key: "limited_guarantee_cap_amount", label: "Limited guarantee cap amount (superseded — see guarantee_limitation_type)", type: "number", entityScope: "loan", factPath: "loan.limited_guarantee_cap_amount", sourceTable: "deal_loan_requests", sourceColumn: "limited_guarantee_cap_amount", appliesToForms: [], requiredForForms: [], sensitive: false },
