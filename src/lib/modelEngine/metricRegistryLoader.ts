...
const V1_SEED: MetricDefinition[] = [
  {
    ...
    version: "v1",
    key: "DSCR",
    dependsOn: ["CASH_FLOW_AVAILABLE", "ANNUAL_DEBT_SERVICE"],
    formula: { type: "divide", left: "CASH_FLOW_AVAILABLE", right: "ANNUAL_DEBT_SERVICE" },
    description: "Debt Service Coverage Ratio",
    regulatoryReference: "OCC 2020-32",
  },
  {
    id: "seed-ebitda-margin",
    version: "v1",
    key: "EBITDA_MARGIN",
    dependsOn: ["EBITDA", "REVENUE"],
    formula: { type: "divide", left: "EBITDA", right: "REVENUE" },
