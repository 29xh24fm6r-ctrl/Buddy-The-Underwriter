...
export const V2_EVENT_CODES = {
  // Existing (Phase 9)
  STANDARD_RENDER_DIFF: "STANDARD_RENDER_DIFF",
  ...
  // New (Phase 13)
  METRIC_REGISTRY_UPGRADE_PREVIEW_RUN: "METRIC_REGISTRY_UPGRADE_PREVIEW_RUN",
  METRIC_REGISTRY_VERSION_DEPRECATED: "METRIC_REGISTRY_VERSION_DEPRECATED",
  METRIC_REGISTRY_DRIFT_DETECTED: "METRIC_REGISTRY_DRIFT_DETECTED",
  BANK_REGISTRY_PINNED: "BANK_REGISTRY_PINNED",
  BANK_REGISTRY_PIN_REMOVED: "BANK_REGISTRY_PIN_REMOVED",
} as const;
...
function mapSeverity(code: V2EventCode): AegisSeverity {
  switch (code) {
    ...
    case "METRIC_REGISTRY_DRIFT_DETECTED":
      return "warning";
    default:
      return "info";
  }
