/**
 * Omega redaction utilities — server-only implementation.
 *
 * This file contains the actual implementation that uses `node:crypto`.
 * All callers should import from `redaction.ts` (the barrel re-export).
 *
