...
export async function createLoanRequest(
  ...
  const { data, error } = await sb
    ...
    .insert({
      ...
      requested_rate_index: input.requested_rate_index ?? null,
      requested_spread_bps: input.requested_spread_bps ?? null,
      requested_interest_only_months: input.requested_interest_only_months ?? null,
