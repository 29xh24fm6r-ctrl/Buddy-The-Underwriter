...
export function RequiredDocuments({ refreshKey }: { refreshKey: number }) {
  ...
  return <section aria-label="Required application documents" className="my-4 space-y-3 rounded-xl border p-4">
    ...
    <p className="text-sm text-slate-600">Buddy checks the files and requested years before preparing your package. Uploading alone does not complete a request.</p>
