  ...
  return (
    ...
    >
      ...
      <section className="mx-auto max-w-[1240px] px-6 pt-14 sm:px-10 sm:pt-[70px]">
        <div className="mx-auto mb-10 max-w-[640px] text-center">
          ...
          <h2
            ...
            style={{ fontFamily: "var(--font-poppins), sans-serif" }}
          >
            Two paths, the same SBA financing
          </h2>
          <p className="text-[16px] leading-relaxed text-[#5b7189]">
            Both lead to the same SBA 7(a) or 504 loan, the same lender
            marketplace, and the same process. Buying into a franchise just
            means Buddy starts already knowing your brand — pick the path
            that matches your deal and Buddy tailors the questions from the
            first message.
          </p>
        </div>
      ...
      <section
        ...
        className="mx-auto max-w-[1240px] px-6 pb-14 sm:px-10 sm:pb-[90px]"
      >
