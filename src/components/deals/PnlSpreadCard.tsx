// src/components/deals/PnlSpreadCard.tsx
"use client";

import React, { useMemo, useState } from "react";
import type { PnlPackage } from "@/lib/finance/pnl";
import { PNL_LINE_LABEL, PNL_LINE_ORDER, type PnlLineId } from "@/lib/finance/pnl/pnl-line-catalog";
...
export default function PnlSpreadCard({ pkg }: { pkg: PnlPackage }) {
